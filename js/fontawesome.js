(function () {
   ...
   * # Reduce
   *
   * A falt object `.reduce()` implementation.
   *
  ...
  var reduce = function faltReduceObject(subject, fn, initialValue, thisContext) {
  ...
  var build = function build() {
    ...
    var hasRegular = 'fal' in styles;
    _byOldName = reduce(shims, function (acc, shim) {
      var oldName = shim[0];
      var prefix = shim[1];
      var iconName = shim[2];

      if (prefix === 'fal' && !hasRegular) {
        prefix = 'fal';
      }
  ...
  function define(prefix, icons) {
     ...
     * for `fal` so we'll easy the upgrade process for our users by automatically defining
     * this as well.
     */

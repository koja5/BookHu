(function () {
  ...
  var build = function build() {
    ...
    var hasRegular = 'fas' in styles;
    _byOldName = reduce(shims, function (acc, shim) {
      var oldName = shim[0];
      var prefix = shim[1];
      var iconName = shim[2];

      if (prefix === 'fas' && !hasRegular) {
        prefix = 'fas';
      }
